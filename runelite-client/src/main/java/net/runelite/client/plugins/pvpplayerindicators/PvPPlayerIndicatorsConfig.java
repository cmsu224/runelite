...
public interface PvPPlayerIndicatorsConfig extends Config {
    ...
    default net.runelite.client.plugins.pvpplayerindicators.TargetHighlightMode highlightTargets() {
        return net.runelite.client.plugins.pvpplayerindicators.TargetHighlightMode.OFF;
    }
    ...
    default net.runelite.client.plugins.pvpplayerindicators.AgilityFormats agilityFormat() {
        return net.runelite.client.plugins.pvpplayerindicators.AgilityFormats.TEXT;
    }

...
import net.runelite.client.plugins.socket.plugins.chat.sChatConfig;
...
implements KeyListener {
    ...
    private void checkOverhead(boolean tickCheck) {
        for (Player p : this.client.getPlayers()) {
            ...
            if (message.isSetOverhead() || tickCheck || this.config.hideLocalPlayerOverhead() && p == this.client.getLocalPlayer() || !this.config.overheadText()) continue;
    ...
    private static class SentSocketMessage {
        ...
        public String toString() {
            return "sChatPlugin.SentSocketMessage(time=" + this.getTime() + ", text=" + this.getText() + ", setOverhead=" + this.isSetOverhead() + ")";
        }

...
import net.runelite.client.plugins.socket.plugins.socketworldhopper.SocketWorldHopperPingOverlay;
import net.runelite.client.plugins.socket.plugins.socketworldhopper.SocketWorldSwitcherPanel;

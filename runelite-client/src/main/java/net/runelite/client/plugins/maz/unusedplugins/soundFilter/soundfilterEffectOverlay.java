...
public class soundfilterEffectOverlay extends OverlayPanel
{
    ...
    @Inject
    public soundfilterEffectOverlay(soundfilterPlugin plugin, Client client, soundfilterConfig config)
    {

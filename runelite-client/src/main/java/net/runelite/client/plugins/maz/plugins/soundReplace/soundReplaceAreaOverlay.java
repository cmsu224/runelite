...
public class soundReplaceAreaOverlay extends OverlayPanel
{
    ...
    @Inject
    public soundReplaceAreaOverlay(soundReplacePlugin plugin, Client client, soundReplaceConfig config)
    {

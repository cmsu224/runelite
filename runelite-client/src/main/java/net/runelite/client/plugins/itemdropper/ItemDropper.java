...
import net.runelite.client.plugins.itemdropper.Queries.InventoryWidgetItemQuery;
...
import net.runelite.client.plugins.itemdropper.utils.ExtUtils;
import net.runelite.client.util.HotkeyListener;

@PluginDescriptor(
        name = "[OPRS] Item Dropper",
        description = "Drops selected items for you.",
        tags = {"item", "drop", "dropper", "bot", "oprs"}
)
@Slf4j

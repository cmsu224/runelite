 ...
 */
package net.runelite.client.plugins.maz.plugins.socket.plugins.socketicedemon.util;
...
public class Raids1Util {
    ...
    public static final int FL_START2_CCW = 0x661660;
    ...
    private static final char[] SORTS = new char[]{'*', '*', 'S', 'F', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'P', 'P', 'P', 'P'};
    private static final String[] NAMES = new String[]{"Floor start", "Floor end", "Scavengers", "Farming", "Shamans", "Vasa", "Vanguards", "Mystics", "Tekton", "Muttadiles", "Guardians", "Vespula", "Ice demon", "Thieving", "Tightrope", "Crabs"};
    ...
    public static int getroom_exitside(int zonecode) {
        return Raids1Util.getroom_winding(zonecode) + Raids1Util.getroom_rot(zonecode) & 3;
    }
}

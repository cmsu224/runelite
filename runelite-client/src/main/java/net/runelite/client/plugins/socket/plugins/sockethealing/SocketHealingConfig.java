...
@ConfigGroup(value="sockethealing")
public interface SocketHealingConfig
extends Config {
    @Range(min=-50, max=50)
    ...
    default public int getIndicatorYOffset() {
        return 5;
    }

    @Range(min=-50, max=50)
    @ConfigItem(position=3, keyName="getIndicatorZOffset", name="Hp Overlay Z Offset", description="This adjusts the height of the health overlay.")
    default public int getIndicatorZOffset() {
        return 0;
    }
    ...
    default public int refreshRate() {
        return 5;
    }
    ...
    default public SocketFontType healingFontType() {
    ...
    default public boolean separateOpactiy() {
        return false;
    }
    ...
    default public boolean displayHealth() {
        return true;
    }
    ...
    default public String highlightedPlayerNames() {
        return "";
    }
    ...
    default public String hpPlayerNames() {
        return "";
    }
    ...
    default public boolean dontShowHp() {
        return false;
    }
    ...
    default public int dontShowHpThreshold() {
        return 100;
    }
    ...
    default public DontShowHpMode dontShowHpMode() {
        return DontShowHpMode.BOTH;
    }
    ...
    default public boolean setHighestPriority() {
        return false;
    }

    @ConfigItem(position=27, keyName="healOtherMES", name="Heal Other MES", description="Prioritizes the lowest hp player in socket for heal other")
    default public boolean healOtherMES() {
        return false;
    }

    public static enum SocketFontType {
        REGULAR,
        BOLD,
        SMALL,
        CUSTOM;
    ...
    public static enum DontShowHpMode {
        OUTLINE,
        TEXT,
        BOTH;

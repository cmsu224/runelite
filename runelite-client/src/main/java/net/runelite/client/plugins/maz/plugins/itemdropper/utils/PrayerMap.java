package net.runelite.client.plugins.maz.plugins.itemdropper.utils;
...
public enum PrayerMap {
    ...
    public static WidgetInfo getWidget(String prayer) {
        return (WidgetInfo)map.getOrDefault(prayer, null);
    }
    ...
    private PrayerMap(String name, WidgetInfo info) {
        this.name = name;
        this.info = info;
    }

    static {
        Builder<String, WidgetInfo> builder = ImmutableMap.builder();
        PrayerMap[] var1 = values();
        int var2 = var1.length;

        for(int var3 = 0; var3 < var2; ++var3) {
            PrayerMap spells = var1[var3];

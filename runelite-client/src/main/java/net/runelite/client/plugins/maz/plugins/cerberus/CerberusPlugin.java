...
import net.runelite.client.plugins.maz.plugins.cerberus.domain.Ghost;
import net.runelite.client.plugins.maz.plugins.cerberus.domain.Phase;
import net.runelite.client.plugins.maz.plugins.cerberus.overlays.CurrentAttackOverlay;
import net.runelite.client.plugins.maz.plugins.cerberus.overlays.PrayerOverlay;
import net.runelite.client.plugins.maz.plugins.cerberus.overlays.SceneOverlay;
import net.runelite.client.plugins.maz.plugins.cerberus.overlays.UpcomingAttackOverlay;

...
import net.runelite.client.plugins.socket.plugins.socketworldhopper.ping.IPHlpAPI;
import net.runelite.client.plugins.socket.plugins.socketworldhopper.ping.IcmpEchoReply;
import net.runelite.client.plugins.socket.plugins.socketworldhopper.ping.RLLibC;
import net.runelite.client.plugins.socket.plugins.socketworldhopper.ping.Timeval;

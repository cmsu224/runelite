...
public class customTimerOverlay extends OverlayPanel{
    private final customTimerPlugin plugin;
    private final customTimerConfig config;

    private String longestString;

    @Inject
    private customTimerOverlay(customTimerPlugin plugin, customTimerConfig config)
    {
        super(plugin);

...
public final class SSLine {
    ...
    public SSLine offset(UnaryOperator<Coordinates> offsetFuncA, UnaryOperator<Coordinates> offsetFuncB) {
        return new SSLine(offsetFuncA == null ? this.coordA : (Coordinates)offsetFuncA.apply(this.coordA), offsetFuncB == null ? this.coordB : (Coordinates)offsetFuncB.apply(this.coordB), this.sigX, this.sigY);
    }
    ...
    public boolean equals(Object other) {
        if (!(other instanceof SSLine)) {
            ...
            return this.coordA.equals(((SSLine)other).coordA) && this.coordB.equals(((SSLine)other).coordB);
        }
    }

    public int hashCode() {
        return Objects.hash(new Object[]{this.coordA, this.coordB, this.sigX, this.sigY});
    }
}

...
import net.runelite.client.plugins.socket.plugins.sotetseg.InvisibleBallOverlay;
import net.runelite.client.plugins.socket.plugins.sotetseg.InvisibleTargetsOverlay;
import net.runelite.client.plugins.socket.plugins.sotetseg.MazeTrueTileOverlay;
import net.runelite.client.plugins.socket.plugins.sotetseg.SotetsegConfig;
import net.runelite.client.plugins.socket.plugins.sotetseg.SotetsegOverlay;

package net.runelite.client.plugins.maz.plugins.itemdropper.Queries;
...
public interface Widget
{
     ...
     */
    net.runelite.api.widgets.Widget setContentType(int contentType);
     ...
     * @see WidgetConfig
     */
    net.runelite.api.widgets.Widget setClickMask(@MagicConstant(flagsFromClass = WidgetConfig.class) int mask);
     ...
     */
    net.runelite.api.widgets.Widget[] getDynamicChildren();
     ...
     */
    net.runelite.api.widgets.Widget[] getStaticChildren();
     ...
     */
    net.runelite.api.widgets.Widget[] getNestedChildren();
     ...
     */
    net.runelite.api.widgets.Widget setText(String text);
     ...
     * @see java.awt.Color#getRGB()
     */
    net.runelite.api.widgets.Widget setTextColor(int textColor);
     ...
     */
    net.runelite.api.widgets.Widget setOpacity(int transparency);
     ...
     */
    net.runelite.api.widgets.Widget setName(String name);
     ...
     * @see WidgetModelType
     */
    net.runelite.api.widgets.Widget setModelId(int id);
     ...
     * @see WidgetModelType
     */
    net.runelite.api.widgets.Widget setModelType(@MagicConstant(valuesFromClass = WidgetModelType.class) int type);
     ...
     * @see net.runelite.api.AnimationID
     */
    net.runelite.api.widgets.Widget setAnimationId(int animationId);
     ...
     * <br>
     * Note: Setting this value outside of the input range defined by {@link net.runelite.api.widgets.Widget#getRotationX()} will cause a client
     *       crash.
     *
     * @param modelX the new model x rotation value
     */
    net.runelite.api.widgets.Widget setRotationX(@Range(from = 0, to = 2047) int modelX);
     ...
     * <br>
     * Note: Setting this value outside of the input range defined by {@link net.runelite.api.widgets.Widget#getRotationY()} will cause a client
     *       crash.
     *
     * @param modelY the new model y rotation value
     */
    net.runelite.api.widgets.Widget setRotationY(@Range(from = 0, to = 2047) int modelY);
     ...
     * <br>
     * Note: Setting this value outside of the input range defined by {@link net.runelite.api.widgets.Widget#getRotationZ()} will cause a client
     *       crash.
     *
     * @param modelZ the new model z rotation value
     */
    net.runelite.api.widgets.Widget setRotationZ(@Range(from = 0, to = 2047) int modelZ);
     ...
     */
    net.runelite.api.widgets.Widget setModelZoom(int modelZoom);
     ...
     */
    net.runelite.api.widgets.Widget setSpriteTiling(boolean tiling);
     ...
     * @see net.runelite.api.SpriteID
     */
    net.runelite.api.widgets.Widget setSpriteId(int spriteId);
     ...
     */
    net.runelite.api.widgets.Widget setHidden(boolean hidden);
     ...
     */
    net.runelite.api.widgets.Widget setItemId(int itemId);
     ...
     */
    net.runelite.api.widgets.Widget setItemQuantity(int quantity);
     ...
     */
    net.runelite.api.widgets.Widget setScrollX(int scrollX);
     ...
     */
    net.runelite.api.widgets.Widget setScrollY(int scrollY);
     ...
     */
    net.runelite.api.widgets.Widget setScrollWidth(int width);
     ...
     */
    net.runelite.api.widgets.Widget setScrollHeight(int height);
     ...
     */
    net.runelite.api.widgets.Widget setOriginalX(int originalX);
     ...
     */
    net.runelite.api.widgets.Widget setOriginalY(int originalY);

    /**
     * Sets the X/Y coordinates
     */
    net.runelite.api.widgets.Widget setPos(int x, int y);
    net.runelite.api.widgets.Widget setPos(int x, int y,
     ...
     */
    net.runelite.api.widgets.Widget setOriginalHeight(int originalHeight);
     ...
     */
    net.runelite.api.widgets.Widget setOriginalWidth(int originalWidth);

    net.runelite.api.widgets.Widget setSize(int width, int height);
    net.runelite.api.widgets.Widget setSize(int width, int height,
     ...
     */
    net.runelite.api.widgets.Widget createChild(int index, @MagicConstant(valuesFromClass = WidgetType.class) int type);
     ...
     * @param type  the {@link WidgetType} of the widget
     */
    net.runelite.api.widgets.Widget createChild(@MagicConstant(valuesFromClass = WidgetType.class) int type);
     ...
     */
    net.runelite.api.widgets.Widget setHasListener(boolean hasListener);
     ...
     * @see net.runelite.api.FontID
     */
    net.runelite.api.widgets.Widget setFontId(int id);
     ...
     */
    net.runelite.api.widgets.Widget setTextShadowed(boolean shadowed);
     ...
     */
    @MagicConstant(valuesFromClass = ItemQuantityMode.class)
    net.runelite.api.widgets.Widget setItemQuantityMode(int itemQuantityMode);
     ...
     * @see WidgetPositionMode
     */
    net.runelite.api.widgets.Widget setXPositionMode(@MagicConstant(valuesFromClass = WidgetPositionMode.class) int xpm);
     ...
     * @see WidgetPositionMode
     */
    net.runelite.api.widgets.Widget setYPositionMode(@MagicConstant(valuesFromClass = WidgetPositionMode.class) int ypm);
     ...
     * @param lineHeight
     */
    net.runelite.api.widgets.Widget setLineHeight(int lineHeight);
     ...
     * @see WidgetTextAlignment
     */
    net.runelite.api.widgets.Widget setXTextAlignment(@MagicConstant(valuesFromClass = WidgetTextAlignment.class) int xta);
     ...
     * @see WidgetTextAlignment
     */
    net.runelite.api.widgets.Widget setYTextAlignment(@MagicConstant(valuesFromClass = WidgetTextAlignment.class) int yta);
     ...
     * @see WidgetSizeMode
     */
    net.runelite.api.widgets.Widget setWidthMode(@MagicConstant(valuesFromClass = WidgetSizeMode.class) int widthMode);
     ...
     * @see WidgetSizeMode
     */
    net.runelite.api.widgets.Widget setHeightMode(@MagicConstant(valuesFromClass = WidgetSizeMode.class) int heightMode);
     ...
     */
    net.runelite.api.widgets.Widget setFilled(boolean filled);
     ...
     */
    net.runelite.api.widgets.Widget getDragParent();

    /**
     * Container this can be dragged in
     */
    net.runelite.api.widgets.Widget setDragParent(net.runelite.api.widgets.Widget dragParent);
    ...
    /**
     * You probably want {@link net.runelite.api.widgets.Widget#getText()} instead
     */
